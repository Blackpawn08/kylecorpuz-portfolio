      ...
      <div className='container contact_container'>
        <div className="contact_options">
          <article className="contact_option">
            ...
            <a href="mailto:corpuzkyle08@gmail.com" target="_blank" rel="noreferrer">Email</a>
          </article>
          ...
          <article className="contact_option">
            ...
            <h4>Messenger</h4>
            <h5>Kyle Corpuz</h5>
            <a href="https://m.me/kyle.corpuz.98" target='_blank' rel="noreferrer">Message me</a>
          </article>
          ...
          <article className="contact_option">
            ...
            <h5>Kyle Corpuz</h5>
            <a href="https://www.youtube.com/@KyleCorpuz/featured" target='_blank' rel="noreferrer">Visit</a>
          </article>
        </div>
